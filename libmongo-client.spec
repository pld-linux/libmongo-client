...
License:	Apache v2.0
Group:		Libraries
Source0:	https://nodeload.github.com/algernon/libmongo-client/tarball/v%{version}#/%{name}-%{version}.tar.gz
# Source0-md5:	efee0539a10e5a36682fdd3380b3d571
...
%prep
%setup -q -n algernon-%{name}-c16e4c2
